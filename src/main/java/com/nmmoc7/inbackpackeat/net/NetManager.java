...
import com.nmmoc7.inbackpackeat.InBackpackEat;
...
public class NetManager {
    ...
    private final SimpleNetworkWrapper channel = NetworkRegistry.INSTANCE.newSimpleChannel(InBackpackEat.MOD_ID);

    int id = 0;

    public NetManager() {
        this.channel.registerMessage(EatClient.Handler.class, EatClient.class, id++, Side.SERVER);
    }
